        ...
        function getBudgetPlan() {
            ...
            if (selectedCity !== "New York City") {
                ...
                budgetPlanDiv.innerHTML = `
                    <p><strong>Income Frequency:</strong> ${selectedPeriod}</p>
                    <p><strong>Savings Percentage:</strong> ${selectedPercentage}%</p>
                    <p><strong>City:</strong> ${selectedCity}</p>

                    <h3>Your Plan:</h3>
                    <p>Based on your selected income frequency and savings percentage, here is your budget plan:</p>
                    <ul>
                        <li>Weekly Income: $${(currentIncome.textContent / 7).toFixed(2)}</li>
                        <li>Monthly Income: $${currentIncome.textContent}</li>
                        <li>Weekly Savings: $${((currentIncome.textContent / 7) * (selectedPercentage / 100)).toFixed(2)}</li>
                        <li>Monthly Savings: $${(currentIncome.textContent * (selectedPercentage / 100)).toFixed(2)}</li>
                        <br>
